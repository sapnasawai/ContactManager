          ...
          <div className="row">
            <div className="col">
              ...
              <p className="fst-italic">
                I believe that I will be joining a very happy company where i
                will be able to explore myself in every dimension very soon with
                the CTC of 10 LPA.
              </p>
            </div>
          </div>
                  ...
                  <div className="card-body">
                    <div className="row">
                      ...
                      <div className="col-md-8">
                        ...
                        <Link
                          to="/contacts/list"
                          className="btn btn-md mt-3 btn-warning"
                        >
                          Back
                        </Link>
                      </div>
